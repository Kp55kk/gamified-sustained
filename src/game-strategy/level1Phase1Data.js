...
export const PHASE1_TASKS = [
  ...
  // ─── TASK 2: Advanced AC Decision ───
  {
    ...
    steps: [
      { id: 'close_window', instruction: 'Walk to Bedroom window 1 → Press E → Close', action: 'closeWindow', icon: '🪟', position: [5, 1.5, -7.0] },
      { id: 'close_curtain', instruction: 'Walk to Bedroom curtain 1 → Press E → Close', action: 'closeCurtain', icon: '🏠', position: [5, 1.5, -7.0] },
      { id: 'close_window2', instruction: 'Walk to Bedroom window 2 → Press E → Close', action: 'closeWindow2', icon: '🪟', position: [2.5, 1.5, -7.0] },
      { id: 'close_curtain2', instruction: 'Walk to Bedroom curtain 2 → Press E → Close', action: 'closeCurtain2', icon: '🏠', position: [2.5, 1.5, -7.0] },
  ...
  // ─── TASK 6: Standby Power Hunt ───
  {
    ...
    shortTitle: 'Standby',
    scenario: {
      description: 'Night-time — all appliances "off" but some still waste energy!',
      indoorTemp: 26,
      outdoorTemp: 24,
      roomSize: 'medium',
      timeOfDay: 'night',
    },
    systemPrompt: 'Even when appliances look OFF, many secretly waste electricity in standby mode!\nFind the hidden energy wasters!',
    appliances: [
      { id: 'stb', name: 'Set-Top Box', icon: '📦', standby: true, standbyW: '8–15W', fact: 'Worst hidden consumer! Standby power nearly equals active power. Wastes 70–131 kWh/year.' },
      { id: 'tv', name: 'Smart TV', icon: '📺', standby: true, standbyW: '1–3W', fact: 'Wi-Fi module stays active for updates and voice assistants even when screen is off.' },
      { id: 'fan', name: 'Ceiling Fan', icon: '🌀', standby: false, standbyW: '0W', fact: 'Mechanical switch means zero standby power when turned off.' },
      { id: 'charger', name: 'Phone Charger', icon: '🔌', standby: true, standbyW: '0.1–0.5W', fact: 'Phantom power! Even without a phone connected, it draws power continuously.' },
      { id: 'mw', name: 'Microwave', icon: '📡', standby: true, standbyW: '3–5W', fact: 'The digital clock display runs 24/7, using 26–44 kWh/year just to show the time!' },
    ],
    scoring: {
      perfect: { label: 'Standby Detective! 🕵️', score: 20, feedback: 'You found ALL hidden energy wasters! You know exactly where phantom power hides.' },
      good: { label: 'Good eye! 👀', score: 15, feedback: 'You spotted most standby wasters! A few sneaky ones escaped.' },
      average: { label: 'Keep looking! 🔍', score: 8, feedback: 'Some hidden consumers escaped your notice. Remember: if it has a light or display, it probably uses standby power.' },
      poor: { label: 'They tricked you! 😅', score: 3, feedback: 'Many hidden consumers went undetected. Standby power is called "vampire power" for a reason!' },
    },
    learning: 'Standby power (phantom/vampire power) wastes 5-10% of household electricity. Unplug or use power strips!',
    markerPosition: [-5, 1.5, -4],
  },
