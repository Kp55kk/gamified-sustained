...
export const PHASE1_TASKS = [
  ...
  {
    id: 'green_pledge', number: 8,
    title: 'The Green Pledge',
    subtitle: 'YOUR PROMISE TO THE PLANET',
    icon: '🌍', color: '#22c55e', colorDot: '🟢',
    objective: 'Build the greenest home possible and take the Green Pledge',
    description: 'After seeing the coal plant, it\'s time to ACT. Build the greenest possible home by choosing ONLY what you truly need. Then take the Green Pledge and see YOUR impact if every student in India joined!',
    instruction: 'Choose appliances wisely → Stay under 150W → Take the Green Pledge!',
    hint: 'Fan (70W) + LED (7W) + WiFi (12W) = 89W — that\'s a green home!',
    type: 'pledge_challenge',
    initialOn: [],
    initialWindows: true, initialCurtains: true,
    targetWatts: 150,
    experimentTime: 20,
    learning: {
      title: '🌍 Pledge Certified!',
      messages: [
        'You proved a family CAN live comfortably under 150W!',
        'That\'s 0.07 kg coal/hr vs 5.4 kg/hr — a 97% reduction!',
        'If every student in India (260 million) takes this pledge:',
        '→ 1.3 BILLION kg less coal burned DAILY',
        '→ 3.7 BILLION kg less CO₂ per DAY',
        '→ Equivalent to planting 170 million trees EVERY DAY!',
        'YOU are the generation that will save the planet! 🌱',
      ],
    },
  },
];
