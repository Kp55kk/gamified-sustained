...
export const L5_QUIZ = [
  ...
  // Sustainability, Decarbonization & Net Zero
  { question: 'What is the primary goal of decarbonization?', options: ['Increasing fossil fuel use', 'Reducing carbon dioxide emissions from energy and industry', 'Making electricity more expensive'], correctIndex: 1, feedback: { correct: 'Decarbonization means reducing CO\u2082 emissions from energy, transport, and industry!', wrong: 'Decarbonization aims to reduce carbon dioxide emissions from all sectors.' }},
  { question: 'What does "Net Zero" emissions mean?', options: ['Zero electricity usage', 'Balancing carbon emitted with carbon removed so net emissions are zero', 'Planting one tree per person'], correctIndex: 1, feedback: { correct: 'Net Zero means the carbon we emit equals the carbon we remove from the atmosphere!', wrong: 'Net Zero means balancing emissions with removal — not zero usage.' }},
  { question: 'Which of these is a key pillar of sustainability?', options: ['Using resources faster', 'Meeting present needs without compromising future generations', 'Maximizing short-term profits'], correctIndex: 1, feedback: { correct: 'Sustainability means meeting today\'s needs without harming future generations\' ability to meet theirs!', wrong: 'Sustainability is about balancing present needs with future well-being.' }},
  { question: 'By what year has India pledged to achieve Net Zero emissions?', options: ['2030', '2050', '2070'], correctIndex: 2, feedback: { correct: 'India has committed to achieving Net Zero emissions by 2070!', wrong: 'India\'s Net Zero target is 2070, announced at COP26.' }},
  { question: 'What is the most effective way to decarbonize the electricity sector?', options: ['Building more coal plants', 'Switching to renewable energy sources like solar and wind', 'Reducing electricity consumption to zero'], correctIndex: 1, feedback: { correct: 'Renewable energy sources like solar and wind produce electricity with zero carbon emissions!', wrong: 'Switching to renewables like solar and wind is the key to decarbonizing electricity.' }},
];
