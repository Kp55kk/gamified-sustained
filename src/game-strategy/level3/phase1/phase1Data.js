...
export const PHASE1_TASKS = [
  ...
  },
  {
    ...
    title: 'Step Outside — Feel the Air',
    subtitle: 'EXPERIENCE POLLUTION',
    icon: '🌫️', color: '#6b7280', colorDot: '⚫',
    objective: 'Go OUTSIDE and experience the air pollution you caused',
    description: 'Your energy use has consequences beyond the walls. Walk through the front door, step OUTSIDE, and press E to feel the air. The pollution is real and VISIBLE!',
    instruction: 'Walk to the front door (left wall) → Walk OUTSIDE through the door → Press E to check air quality',
    hint: 'Walk through the gap in the left wall to go outside!',
    type: 'walk_outside_air',
    allowOutside: true,
    ...
    learning: {
      ...
      messages: [
        ...
        'AQI above 200 is HAZARDOUS — you just experienced it!',
      ],
    },
  },
  {
    id: 'eb_meter_check', number: 6,
    title: 'Read Your EB Meter',
    subtitle: 'THE TRUTH IN NUMBERS',
    icon: '📊', color: '#8b5cf6', colorDot: '🟣',
    objective: 'Go outside and read the Indian EB Meter to see your consumption',
    description: 'Every home has an EB Meter outside. Walk to the meter board on the left wall outside your house and press E. The numbers will SHOCK you!',
    instruction: 'Walk OUTSIDE through the front door → Find the EB Meter on the wall → Press E to read it',
    hint: 'The EB meter is on the left wall, just outside the front door!',
    type: 'eb_meter_outside',
    allowOutside: true,
    initialOn: ['ac_1_5ton', 'geyser', 'tv_smart', 'led_tube', 'ceiling_fan', 'fridge'],
    initialWindows: false, initialCurtains: false,
    learning: {
      title: '💡 The Meter Never Lies',
      messages: [
        'Your EB meter records EVERY unit of electricity you use',
        'Each unit (kWh) burns ~0.71 kg of coal at a power plant',
        'Average Indian home: 90 units/month. Your wasteful home: 400+ units!',
        'The bill hits YOUR family\'s pocket — ₹3000+ per month!',
        'Smart usage can cut your bill by 60% — savings of ₹1800/month!',
      ],
    },
  },
  {
    id: 'factory_visit', number: 7,
    title: 'Inside the Power Plant',
    subtitle: 'SEE COAL BURNING',
    icon: '🏭', color: '#dc2626', colorDot: '🔴',
    objective: 'Enter the power plant and witness coal burning for YOUR electricity',
    description: 'There is a power plant near your house. Walk outside, find the factory, and ENTER it. Inside you will SEE coal being burned, furnaces blazing, and CO₂ being released — all because of YOUR appliances!',
    instruction: 'Walk OUTSIDE → Follow the path to the Factory 🏭 → Walk inside → Witness the coal burning process',
    hint: 'The factory is to the LEFT of your house. Walk along the path!',
    type: 'factory_visit',
    allowOutside: true,
    initialOn: ['ac_1_5ton', 'geyser', 'tv_smart', 'led_tube', 'ceiling_fan', 'fridge', 'induction'],
    initialWindows: false, initialCurtains: false,
    learning: {
      ...
      messages: [
        ...
        'A single power plant burns 20,000 tons of coal PER DAY',
        'The smoke you saw causes acid rain, lung disease, and climate change',
        'Renewable energy (solar, wind) produces ZERO CO₂ — that\'s the future!',
      ],
    },
  },
  {
    id: 'energy_comparison', number: 8,
    title: 'The Energy Comparison',
    subtitle: 'FAN vs AC — THE REAL COST',
    icon: '⚖️', color: '#f59e0b', colorDot: '🟡',
    objective: 'Experiment: Compare fan+ventilation vs AC cooling. See the real energy difference!',
    description: 'You now know the environmental damage. But HOW MUCH can smart choices save? Try different setups — fan only, AC at 24°C, or full overload — and see the LIVE impact on watts, CO₂, and your monthly bill. Then ask yourself: even at the best setup, is coal-powered electricity truly clean?',
    instruction: 'Toggle appliances freely → Watch the dashboard numbers change → Try to get the LOWEST wattage possible while staying comfortable!',
    hint: 'Fan + open window = 70W. AC at 24°C sealed = 1200W. Which is smarter?',
    type: 'free_play',
    experimentTime: 25,
    initialOn: ['ac_1_5ton', 'geyser', 'led_tube'],
    initialWindows: false, initialCurtains: false,
    learning: {
      title: '💡 The Path Forward',
      messages: [
        'Even at 70W (fan only), you still burn coal at the power plant',
        '70% of India\'s electricity comes from fossil fuels',
        'Reducing usage helps — but it\'s NOT enough!',
        'The real solution? Change the SOURCE of energy!',
        'Solar panels produce clean energy immediately — zero CO₂!',
        'In Phase 2, you will TRANSFORM this home using renewables! 🌱☀️🌬️',
      ],
    },
  },
];
