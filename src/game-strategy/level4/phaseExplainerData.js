...
export const EXPLAINER_TOPICS = {
  ...
  panel_basics: {
    name: 'Solar Panel Basics', color: '#fbbf24', steps: [
      ...
      { title: 'Types of Solar Panels', svg: 'panel_types',
        desc: 'Black Panels (best quality): Makes the most electricity (20-22%). Blue Panels (good quality): Cheaper but still good (15-17%). Both last 25-30 years!',
  ...
  net_meter: {
    name: 'Net Meter', color: '#22c55e', steps: [
      { title: 'What is a Net Meter?', svg: 'meter_spin',
        ...
        fact: 'Your meter actually runs backward when you send solar power back — you EARN credits on your bill!' },
  ...
  system_types: {
    name: 'Solar System Types', color: '#60a5fa', steps: [
      ...
      { title: 'Off-Grid System', svg: 'sys_offgrid',
        desc: 'Completely independent — no connection to the grid! Uses batteries to store power for night. Costs 40-60% more because of batteries. Perfect for far-away areas with no grid power.',
  ...
  smart_sensors: {
    name: 'Smart Sensors', color: '#8b5cf6', steps: [
      ...
      { title: 'Types of Smart Sensors', svg: 'sensor_types',
        desc: 'Motion Sensor (Rs.500/room): Detects if someone is in the room and turns lights ON/OFF automatically. Smart Thermostat (Rs.3,000): Keeps AC at 24 degrees automatically — every 1 degree lower wastes 6% more electricity!',
        fact: 'Setting AC at 24 degrees instead of 20 degrees saves 24% electricity. That is Rs.500-800 less per month!',
        quiz: { q: 'How much electricity does each 1 degree lower AC setting waste?', opts: ['2%', '6%', '10%'], ans: 1 }},
  ...
  maintenance: {
    name: 'Panel Maintenance', color: '#22c55e', steps: [
      { title: 'Why Clean Your Panels?', svg: 'maint_dirty',
        desc: 'Dust, bird droppings, and leaves block sunlight from reaching the solar cells. Dirty panels lose 15-25% of their power! Clean panels = more electricity = more savings.',
      ...
      { title: 'Yearly Checkup', svg: 'maint_check',
        desc: 'Once a year, call a technician for a full checkup (Rs.2,000-3,000). They check wiring, connections, inverter health, and panel condition. Panels lose only 0.5% per year — after 25 years still 87.5% power!',
  ...
  monsoon_prep: {
    name: 'Monsoon Safety', color: '#3b82f6', steps: [
      { title: 'Lightning: The Big Danger', svg: 'monsoon_lightning',
        desc: 'Lightning strikes can destroy your solar system in one second! One strike = Rs.1-2 Lakh damage. But a simple lightning protector (Rs.3,000-5,000) protects your entire system. Always install one!',
        fact: 'India has about 2,500 lightning deaths per year. A proper protector makes your home SAFER during storms.' },
      { title: 'Protection Equipment', svg: 'monsoon_protect',
        desc: 'You need 3 things: Lightning Protector on the roof (Rs.3-5K). Surge Protector on the inverter (Rs.2-3K). Earth Grounding with 3 copper rods (Rs.5-8K). Total: Rs.10-16K for complete storm protection.',
        fact: 'Without grounding, a lightning strike travels through wires and can damage ALL electronics in your home!',
        quiz: { q: 'What protects solar panels from lightning?', opts: ['Covering them with cloth', 'Lightning protector + earthing', 'Turning them off'], ans: 1 }},
      { title: 'Wind & Waterproofing', svg: 'monsoon_wind',
        desc: 'Good mounting frames handle winds up to 150 km/h (that is like a super cyclone!). All junction boxes are fully waterproof — completely sealed from rain. The tilt angle helps rain slide off and clean the panels naturally.',
  ...
  co2_impact: {
    name: 'CO2 & Pollution', color: '#22c55e', steps: [
      { title: 'What is CO2?', svg: 'co2_what',
        desc: 'CO2 (Carbon Dioxide) is a gas that traps heat in our atmosphere, like a blanket around Earth. Burning coal and petrol releases CO2. Too much CO2 = Earth gets hotter = climate change, floods, and droughts.',
        fact: 'India\'s electricity comes 70% from burning coal. Every unit of grid electricity releases about 0.82 kg of CO2!' },
      { title: 'How Solar Stops CO2', svg: 'co2_prevent',
        desc: 'Solar panels make electricity WITHOUT burning anything — ZERO CO2! A 5kW home system prevents 6,150 kg of CO2 every year. That is like taking 2 cars off the road!',
        fact: 'Over 25 years, one solar home prevents 153 TONNES of CO2 — that is the weight of 25 elephants!',
        quiz: { q: 'How much CO2 does a 5kW solar system prevent per year?', opts: ['100 kg', '1,000 kg', '6,150 kg'], ans: 2 }},
      { title: 'Trees Saved', svg: 'co2_trees',
        desc: 'One 5kW solar system = planting 280 Neem trees! If 1 crore Indian homes go solar (PM Surya Ghar target), it equals India\'s entire airplane pollution. Solar is the fastest way to fight climate change.',
  ...
  community: {
    name: 'Community Solar', color: '#60a5fa', steps: [
      { title: 'What is Community Solar?', svg: 'community_what',
        desc: 'Community solar means a group of homes or an apartment building shares one big solar system. Instead of each home installing panels, the whole building installs them together on the common rooftop.',
  ...
  future_tech: {
    name: 'Future Solar Tech', color: '#a78bfa', steps: [
      { title: 'Two-Sided Panels', svg: 'future_bifacial',
        ...
        fact: 'White rooftops reflect more light to the back of two-sided panels — just painting your roof white can increase output by 15%!' },
      { title: 'Solar Roof Tiles', svg: 'future_tiles',
        ...
        quiz: { q: 'How much more electricity do two-sided panels make?', opts: ['1-3% more', '10-30% more', '100% more'], ans: 1 }},
      { title: 'Super Batteries of the Future', svg: 'future_battery',
        desc: 'Solid-state batteries (coming 2026-2028) will store 2x more energy, charge faster, and last 20+ years. New super-material solar cells (being tested now) can reach 30%+ efficiency and can be printed like newspapers!',
  ...
  knowledge_check: {
    name: 'Knowledge Review', color: '#a78bfa', steps: [
      ...
      { title: 'Installation & Money Review', svg: 'review_install',
        desc: 'Panels face TRUE SOUTH at tilt angle = your latitude. Shadows reduce output by 30-50%. PM Surya Ghar gives Rs.78,000 subsidy. Modern Lithium is the best battery type. Load shifting saves Rs.1,500/month.',
      ...
      { title: 'Environment Review', svg: 'review_env',
        desc: 'One 5kW solar home prevents 6,150 kg CO2/year = 280 trees planted. Over 25 years: 153 tonnes prevented. 5-star appliances save Rs.15,000/year. Solar + EV = Rs.0/km driving cost!',
  ...
  action_plan: {
    name: '10-Step Action Plan', color: '#f59e0b', steps: [
      { title: 'Steps 1-4: Get Started', svg: 'action_start',
        desc: '1. Visit pmsuryaghar.gov.in and register. 2. Get a site check from your electricity company. 3. Choose a Hybrid system for best results. 4. Select a government-approved solar company with good reviews.',
      ...
      { title: 'Steps 5-7: Install Right', svg: 'action_install',
        desc: '5. Check your roof can handle the weight (15-18 kg per square meter). 6. Install panels facing South at your latitude angle. 7. Apply for net meter through your electricity company portal.',
        fact: 'A good vendor handles everything — from paperwork to net meter application. You just sign and approve!',
      ...
      { title: 'Steps 8-10: Save the Most', svg: 'action_save',
