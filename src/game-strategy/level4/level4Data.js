...
export const L4_PHASES = [
  ...
  },
  {
    ...
    desc: 'Walk around the house and learn about the 4 core components: panels, inverter, net meter, and system types.',
    objective: 'Visit all 4 solar components and learn how they work together.',
    learning: 'Photovoltaic cells, DC→AC conversion, net metering, on/off/hybrid systems',
  },
  {
    id: 'installation_science', title: 'Panel Science & Setup', icon: '📐', duration: '3-4 min',
    desc: 'Learn the science behind optimal panel installation — tilt angle, shadow analysis, and roof requirements.',
    objective: 'Understand why tilt = latitude, shadow kills output, and roof strength matters.',
    learning: 'Tilt angle optimization, shadow analysis, roof load calculation',
  },
  {
    id: 'subsidies_roi', title: 'PM Surya Ghar & Financing', icon: '🏛️', duration: '4-5 min',
    desc: 'Explore government subsidies, cost breakdown, tariff slabs, and financing options for solar.',
    objective: 'Learn about PM Surya Ghar scheme, ROI calculator, and solar loan options.',
    learning: 'MNRE subsidies, cost breakdown, tariff slabs, SBI solar loan, RESCO model',
  },
  {
    id: 'battery_storage', title: 'Battery & Energy Storage', icon: '🔋', duration: '3-4 min',
    desc: 'Learn about battery technologies, sizing, and the daily charge/discharge cycle.',
    objective: 'Understand LiFePO4 vs Lead-Acid, calculate night-time needs, and learn the daily cycle.',
    learning: 'Battery types, sizing calculator, charge/discharge cycle, grid independence',
  },
  {
    id: 'smart_energy', title: 'Smart Energy Management', icon: '🤖', duration: '4-5 min',
    desc: 'Master load shifting, smart sensors, BEE ratings, and EV+Solar synergy.',
    objective: 'Learn to schedule appliances, install sensors, buy 5-star, and charge EVs with solar.',
    learning: 'Load shifting, IoT sensors, BEE star ratings, EV+Solar cost comparison',
  },
  {
    id: 'weather_maintenance', title: 'Weather & Maintenance', icon: '🌦️', duration: '3-4 min',
    desc: 'Understand seasonal output variations, panel cleaning, and storm preparedness.',
    objective: 'Learn seasonal solar output, maintenance schedule, and monsoon safety measures.',
    learning: 'Seasonal variation, panel cleaning, lightning protection, degradation rates',
  },
  {
    id: 'environmental_impact', title: 'Environmental Impact', icon: '🌿', duration: '3-4 min',
    desc: 'See the massive environmental impact of your solar home — CO₂ prevented, trees saved, future tech.',
    objective: 'Understand carbon footprint reduction, community solar, and future solar technologies.',
    learning: 'CO₂ reduction, community solar, India targets, bifacial panels, perovskite cells',
  },
  {
    id: 'total_impact', title: 'Total Impact & Action Plan', icon: '📈', duration: '3-4 min',
    desc: 'Review your complete financial impact, knowledge checklist, and 10-step action plan to go solar.',
    objective: 'See 25-year ROI, verify 80%+ knowledge, and get your personalized action plan.',
    learning: '25-year financial view, knowledge verification, 10-step action plan',
  },
  {
    id: 'finale', title: 'Solar Champion', icon: '🏆', duration: '2-3 min',
    desc: 'See the dramatic before/after transformation — you are now a Solar Champion ready for India\'s clean energy future.',
